        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc pl-4 space-y-2.5 text-ink-500 text-xs sm:text-sm">
              ...
              <li><strong className="text-ink-900">Manpower Planning & Development Dashboard:</strong> Developed a dedicated Power BI dashboard to guide HR and Director-level decisions on managing employee outflow and ensuring smooth manufacturing operations. Tracked data to manage employee welfare activities, supervise mess food quality, prepare weekly food menus, and resolve day-to-day operational problems.</li>
            </ul>
          </div>
        </div>
      )
